...
void xmem_rw_test(){
    ...
    xmem_element_verify( xmem.xor_val8   );
    xmem_element_verify( xmem.xor_val16   );
    xmem_element_verify( xmem.xor_val32   );

    xmem_element_verify( xmem.arr_complete   );

    xmem_element_verify( xmem.vec_s1   );
    xmem_element_verify( xmem.vec_s1   );
    xmem_element_verify( xmem.vec_d1   );

    xmem_element_verify( xmem.tc_arr   );
    xmem_element_verify( xmem.no_p_arr   );
    xmem_element_verify( xmem.no_q_arr   );

    xmem_element_verify( xmem.arr_s1   );
    xmem_element_verify( xmem.arr_s2   );
    xmem_element_verify( xmem.arr_d1   );

    xmem_element_verify( xmem.pix_base   );
