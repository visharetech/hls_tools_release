...
#define ADMA_IO 	 	  ((0x1<<31)+(0x11<<24))   //previous: RESERVED_17_IO
...
#define L2CACHE_CTRL      ((0x1<<31)+(0x1c<<24))   //previous: COLORBAR_VOUT_IO,temporary add to test colorbar module
